...
namespace HotelReservations.Behaviours;
    ...
    where TResponse : class
{
    ...
    public async Task<TResponse> Handle(TRequest request, CancellationToken cancellationToken, RequestHandlerDelegate<TResponse> next)
    {
        ...
        if (failures.Count != 0)
        {
            ...
            return Activator.CreateInstance(typeof(TResponse), "Invalid state of the data", failures.Select(s => s.ErrorMessage).ToList()) as TResponse;
        }
